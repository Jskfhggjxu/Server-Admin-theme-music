...
local function ServerAdmin()
    ...
    local BMUSIC = IT("https://raw.githubusercontent.com/Jskfhggjxu/Server-Admin-theme-music/refs/heads/main/server%20admin%20start.mp3",RootPart)
    local VOLUME = 1
    local PITCH = 1
    ...
    game:GetService('RunService').Stepped:Connect(function()
        if reanimated == true then
        	...
        	BMUSIC.SoundId = "rbxassetid://https://raw.githubusercontent.com/Jskfhggjxu/Server-Admin-theme-music/refs/heads/main/server%20admin%20loop.mp3"..SONGID
        	BMUSIC.Looped = true
        	BMUSIC.Pitch = PITCH
